        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/stories" className="text-gray-800 hover:text-pink-500 dark:text-gray-300 dark:hover:text-pink-400 transition-colors">Stories</Link>
              </li>
              <li>
                <Link to="/share-story" className="text-gray-800 hover:text-pink-500 dark:text-gray-300 dark:hover:text-pink-400 transition-colors">Share Story</Link>
              </li>
              <li>
                <Link to="/resources" className="text-gray-800 hover:text-pink-500 dark:text-gray-300 dark:hover:text-pink-400 transition-colors">Resources</Link>
              </li>
              <li>
                <Link to="/faqs" className="text-gray-800 hover:text-pink-500 dark:text-gray-300 dark:hover:text-pink-400 transition-colors">FAQs</Link>
              </li>
              <li>
                <Link to="/about" className="text-gray-800 hover:text-pink-500 dark:text-gray-300 dark:hover:text-pink-400 transition-colors">About</Link>
              </li>
              <li>
                <Link to="/PrivacyPolicy" className="text-gray-800 hover:text-pink-500 dark:text-gray-300 dark:hover:text-pink-400 transition-colors">Privacy Policy</Link>
              </li>
              <li>
                <Link to="/termsandconditions" className="text-gray-800 hover:text-pink-500 dark:text-gray-300 dark:hover:text-pink-400 transition-colors">Terms and Conditions</Link>
              </li>
            </ul>
          </div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a
                  ...
                  className="text-gray-800 hover:text-pink-500 dark:text-gray-300 dark:hover:text-pink-400 transition-colors"
                >
                  Contact Us
                </a>
              </li>
