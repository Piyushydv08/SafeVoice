      ...
      <section className="mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          {[
            ...
            <div
              key={index}
              className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 text-center group border border-transparent hover:border-pink-400 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-pink-200 to-purple-200 dark:from-pink-900/40 dark:to-purple-900/40 opacity-0 group-hover:opacity-20 rounded-2xl transition duration-500"></div>
      ...
      <section className="mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {[
            ...
            <div
              key={index}
              className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-md p-10 text-center overflow-hidden transition duration-500 hover:scale-105 hover:shadow-xl hover:-translate-y-2"
            >
