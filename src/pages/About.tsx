        ...
        <section className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            {[
              ...
              <div
                key={index}
                className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 text-center group border border-transparent hover:border-pink-400 hover:shadow-2xl transition-all duration-500"
              >
