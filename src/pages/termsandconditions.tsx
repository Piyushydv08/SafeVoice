...
export default function TermsAndConditions() {
  return (
    <div className="max-w-7xl mx-auto mt-20 px-4 sm:px-6 lg:px-8 py-8 bg-white dark:bg-gray-900">
      ...
      {/* Quick Overview */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Terms at a Glance</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 text-center">
            <Heart className="h-8 w-8 text-red-500 mx-auto mb-3" />
            <h3 className="font-semibold mb-2 dark:text-white">Respectful Community</h3>
            <p className="text-gray-600 dark:text-gray-300 text-sm">Treat all members with kindness and respect</p>
          </div>
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 text-center">
            <Shield className="h-8 w-8 text-green-500 mx-auto mb-3" />
            <h3 className="font-semibold mb-2 dark:text-white">Safety First</h3>
            <p className="text-gray-600 dark:text-gray-300 text-sm">We prioritize user safety and well-being</p>
          </div>
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 text-center">
            <Lock className="h-8 w-8 text-blue-500 mx-auto mb-3" />
            <h3 className="font-semibold mb-2 dark:text-white">Privacy Protected</h3>
            <p className="text-gray-600 dark:text-gray-300 text-sm">Your stories and data are kept secure</p>
          </div>
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 text-center">
            <Users className="h-8 w-8 text-purple-500 mx-auto mb-3" />
            <h3 className="font-semibold mb-2 dark:text-white">Community Guidelines</h3>
            <p className="text-gray-600 dark:text-gray-300 text-sm">Clear rules for positive interactions</p>
          </div>
        </div>
      </section>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-pink-50 dark:bg-pink-900/20 border-l-4 border-pink-500 p-4">
              <h3 className="font-semibold text-pink-800 dark:text-pink-300 mb-2">Age Requirement</h3>
      ...
      <section className="mb-12">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Account Registration & Responsibilities</h2>
          
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-3">Creating Your Account</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-3">Account Security</h3>
      ...
      <section className="mb-12">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Content Guidelines</h2>
          
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-3">Your Content Rights</h3>
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                <h4 className="font-semibold text-blue-800 dark:text-blue-300 mb-2">Content License</h4>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-3">Content Standards</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg">
                  <h4 className="font-semibold text-green-800 dark:text-green-300 mb-2">Appropriate Content</h4>
                ...
                <div className="bg-red-50 dark:bg-red-900/20 p-4 rounded-lg">
                  <h4 className="font-semibold text-red-800 dark:text-red-300 mb-2">Prohibited Content</h4>
      ...
      <section className="mb-12">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Platform Usage Rules</h2>
          
          <div className="space-y-4">
            <div>
              <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-3">Acceptable Use</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-3">You agree to use SafeVoice only for its intended purpose:</p>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-3">Technical Restrictions</h3>
              <div className="bg-red-50 dark:bg-red-900/20 border-l-4 border-red-500 p-4">
                <h4 className="font-semibold text-red-800 dark:text-red-300 mb-2">You Must Not:</h4>
                <ul className="text-red-700 dark:text-red-300 text-sm space-y-1">
      ...
      <section className="mb-12">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Moderation & Enforcement</h2>
          
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-3">Content Moderation</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg">
                  <h4 className="font-semibold text-yellow-800 dark:text-yellow-300 mb-2">Warning</h4>
                  <p className="text-yellow-700 dark:text-yellow-300 text-sm">First violation may result in a warning and content removal</p>
                </div>
                <div className="bg-orange-50 dark:bg-orange-900/20 p-4 rounded-lg">
                  <h4 className="font-semibold text-orange-800 dark:text-orange-300 mb-2">Suspension</h4>
                  <p className="text-orange-700 dark:text-orange-300 text-sm">Repeated violations may lead to temporary suspension</p>
                </div>
                <div className="bg-red-50 dark:bg-red-900/20 p-4 rounded-lg">
                  <h4 className="font-semibold text-red-800 dark:text-red-300 mb-2">Termination</h4>
                  <p className="text-red-700 dark:text-red-300 text-sm">Severe or persistent violations result in account termination</p>
                </div>
              </div>
            </div>

            <div>
              <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-3">Reporting System</h3>
              <p className="text-gray-600 dark:text-gray-300">
      ...
      <section className="mb-12">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Important Disclaimers</h2>
          ...
          <div className="space-y-6">
            <div className="bg-yellow-50 dark:bg-yellow-900/20 border-l-4 border-yellow-500 p-4">
              <div className="flex">
                ...
                <div>
                  <h3 className="text-yellow-800 dark:text-yellow-300 font-semibold">Not Professional Medical or Legal Advice</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-3">Platform Availability</h3>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-3">User-Generated Content</h3>
              <p className="text-gray-600 dark:text-gray-300">
      ...
      <section className="mb-12">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
              <h3 className="font-semibold text-gray-800 dark:text-white mb-2">Maximum Liability</h3>
      ...
      <section className="mb-12">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Account Termination</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-3">Termination by You</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-3">Termination by Us</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-3">
          ...
          <div className="mt-6 bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
            <h3 className="font-semibold text-blue-800 dark:text-blue-300 mb-2">Effect of Termination</h3>
            <p className="text-blue-700 dark:text-blue-300 text-sm">
      ...
      <section className="mb-12">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-3">Governing Law</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-3">Dispute Resolution</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
          ...
          <div className="mt-6">
            <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-3">Severability</h3>
            <p className="text-gray-600 dark:text-gray-300 text-sm">
      ...
      <section className="mb-12">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Questions About These Terms</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-lg font-semibold mb-3 dark:text-white">General Questions</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-2">
                For questions about these Terms and Conditions:
              </p>
              <p className="text-gray-600 dark:text-gray-300">
                Email: <a href="mailto:legal@safevoiceforwomen.com" className="text-pink-500 hover:text-pink-600 dark:text-pink-400 dark:hover:text-pink-300">legal@safevoiceforwomen.com</a>
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-3 dark:text-white">Support & Help</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-2">
                For platform support and assistance:
              </p>
              <p className="text-gray-600 dark:text-gray-300">
                Email: <a href="mailto:safevoiceforwomen@gmail.com" className="text-pink-500 hover:text-pink-600 dark:text-pink-400 dark:hover:text-pink-300">safevoiceforwomen@gmail.com</a>
              </p>
            </div>
          </div>
