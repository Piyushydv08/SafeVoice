    ...
    <div className='bg-white dark:bg-gray-900 min-h-screen'>
      <div className="max-w-7xl mx-auto mt-16 px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* Contact Form */}
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 transition duration-500">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-all duration-200 bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    value={formData.body}
                    onChange={handleChange}
                    className="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-all duration-100 resize-none bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 hover:shadow-2xl hover:scale-[1.01] transition duration-400">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900 dark:text-white">General Inquiries</p>
                    <a
